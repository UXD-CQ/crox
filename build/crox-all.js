 ...
 * md5: 2c4b3337e9079e6be8238404a8181725
 */
...
var parse = function() {
	...
	function parse(lexer, extra) {
		...
		throw Error('Syntax error: ' + a.pos + '\nfind ' + a.tag + '\nexpect ' + okTokens.join(' '));
	}
	return parse;
}();
...
Crox.version = "1.4.9";return Crox;})();if ( typeof module == "object" && module && typeof module.exports == "object" ) module.exports = Crox;else if (typeof define == "function" && (define.amd || define.cmd) ) define(function () { return Crox; } );else if (typeof KISSY != "undefined") KISSY.add(function(){ return Crox; });if (root) root.Crox = Crox; })(this);